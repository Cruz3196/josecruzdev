...
const CTA = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://localhost:5001/api/send-email', {
                method: 'POST',
                headers: {
    ...
    return (
        <footer id="contact" className="footer footer-horizontal footer-center text-base-content py-12 px-4">
            ...
            <aside>
                ...
                Built with <span className='text-teal-400'>Coffee</span> & <span className='text-teal-400'>Love</span>.</p>
            </aside>
        </footer>
    )
}
