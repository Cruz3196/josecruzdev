    ...
    return (
        <div className="navbar bg-base-100 px-0 my-0 sticky top-0 z-50 h-20">
            ...
            <div className="navbar-end gap-2">
                ...
                <button className="border-solid border-1 rounded-full flex items-center justify-center shadow-md">
                    <label className="swap swap-rotate">
                        ...
                        {/* sun icon */}
                        <svg
                            className="swap-off h-6 w-10 fill-current my-2"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            className="swap-on h-6 w-10 my-2 text-teal-400"
                            viewBox="0 0 16 16"
                            fill="currentColor"
                            >
